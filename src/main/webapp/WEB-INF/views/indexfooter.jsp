					...
					<div class="container">
						<div class="row">
							<div class="col-lg-4 col-sm-8 mb-5 mb-lg-0">
								<!-- logo -->
								<a class="logo-footer" href="index.html"><img class="img-fluid mb-4" src="<c:url value="
							...
							<div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-5 mb-md-0">
								...
								<ul class="list-unstyled">
									<li class="mb-3"><a class="text-color" href="<c:url value="
											https://themefisher.com/blog" />">Forums</a></li>
									<li class="mb-3"><a class="text-color" href="<c:url value="
											https://docs.themefisher.com/" />">Documentation</a></li>
									<li class="mb-3"><a class="text-color" href="<c:url value=" #!" />">Language</a>
									</li>
									<li class="mb-3"><a class="text-color" href="<c:url value=" #!" />">Release
										Status</a></li>
								</ul>
							</div>
							<!-- support -->
							<div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-5 mb-md-0">
								...
								<ul class="list-unstyled">
									<li class="mb-3"><a class="text-color" href="<c:url value="
											https://themefisher.com/" />">WordPress</a></li>
									<li class="mb-3"><a class="text-color" href="<c:url value="
											https://themefisher.com/" />">LearnPress</a></li>
									<li class="mb-3"><a class="text-color" href="<c:url value="
											https://themefisher.com/" />">WooCommerce</a></li>
									<li class="mb-3"><a class="text-color" href="<c:url value="
											https://themefisher.com/" />">bbPress</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-sm-7 text-sm-left text-center">
								<p class="mb-0">
									...
									, designed & developed by <a href="<c:url value=" https://themefisher.com/" />"
									class="text-muted">Themefisher</a>
								</p>
							</div>
							<div class="col-sm-5 text-sm-right text-center">
								<ul class="list-inline">
									<li class="list-inline-item"><a class="d-inline-block p-2" href="<c:url value="
											https://facebook.com/themefisher/" />"><i
											class="ti-facebook text-primary"></i></a></li>
									<li class="list-inline-item"><a class="d-inline-block p-2" href="<c:url value="
											https://twitter.com/themefisher" />"><i
											class="ti-twitter-alt text-primary"></i></a></li>
									<li class="list-inline-item"><a class="d-inline-block p-2" href="<c:url value="
											https://github.com/themefisher" />"><i
											class="ti-github text-primary"></i></a></li>
									<li class="list-inline-item"><a class="d-inline-block p-2" href="<c:url value="
											https://instagram.com/themefisher/" />"><i
