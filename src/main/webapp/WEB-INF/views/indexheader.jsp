									...
									<c:if test="${sessionuserRole=='Admin'}">
										<li class="nav-item dropdown view"><a
											...
											<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
												...
												<li><a class="dropdown-item"
													href='<c:url value="/add-subscription-plan"/>'>Add
														Subscription plan</a></li>
												<li><a class="dropdown-item"
													href='<c:url value="/show-plan-list"/>'>Show
														Subscription plan</a></li>
											</ul></li>
									</c:if>
									<li>
										<div style="margin-top: 35px;">
											<a href="<c:url value="/profile/profiledetail" />"> <img
												src="${pageContext.request.contextPath}${'\\'}${sessionimg}"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h1 class="modal-title fs-5" id="exampleModalLabel">Subscription
						Plan</h1>
				...
				<div class="modal-body">
					...
					<div class="mt-4 mb-4">
						<button type="button" class="plans"
							style="background-color: #E2EC57;"
							onclick="location.href='<c:url value="/monthly-subscription" />'">Monthly
							Plan</button>
					</div>
					<div class="mt-4 mb-4">
						<button type="button" class="plans"
							style="background-color: #D2DE20;"
