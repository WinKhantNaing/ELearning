                    ...
                    <div class="row gutters-sm">
                        <div class="col-sm-6 mb-3">
                            <div class="card h-100">
                                <div class="card-body">
                                    <h6 class="d-flex align-items-center mb-3" style="color: #FFEA00;">Histroy Courses
                                    </h6>
                                    <table>
                                    <tr >
                                   ...
                                   <%--  <ul>
                                    <c:forEach items="${payDescription }" var="bean">
                                    <li>
                                            <small>${bean.subPlan}(${bean.duration})&ensp; &ensp;${bean.startDate}&ensp; &ensp;${bean.endDate}</small>
                                        </li>
                                    </c:forEach>
