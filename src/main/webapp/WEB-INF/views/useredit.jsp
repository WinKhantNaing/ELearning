    ...
    <div class="center-form">
        ...
        <form:form action="../updateuser" method="post" modelAttribute="eubean">
            ...
            <div class="form-group">
                ...
                <form:input type="text" path="userName" id="userName" class="form-control d-inline-block" style="width: calc(100% - 120px);"/>
            </div>
            <div class="form-group">
                <label for="userEmail" class="form-label">Email:</label>
                <form:input type="text" path="userEmail" id="userEmail" class="form-control d-inline-block" style="width: calc(100% - 120px);"/>
            </div>
            <%-- <div class="form-group">
