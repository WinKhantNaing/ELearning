			...
			<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
				...
				<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
					...
					<head>
						...
						<link href="https://cdn.materialdesignicons.com/5.4.55/css/materialdesignicons.min.css"
							rel="stylesheet">
						...
						<link href="<c:url value =" /resources/vendor/font-awesome-4.7/css/font-awesome.min.css" />"
						rel="stylesheet" media="all">
						<link href="<c:url value =" /resources/vendor/select2/select2.min.css" />"
						rel="stylesheet" media="all">
						<link href="<c:url value =" /resources/vendor/datepicker/daterangepicker.css" />"
						rel="stylesheet" media="all">
									...
									<div class="modal fade" id="exampleModal" tabindex="-1"
										...
										<div class="modal-dialog modal-dialog-centered">
											<div class="modal-content">
												...
												<form:form action="profilePhoto" method="post" modelAttribute="pbean"
															...
															<form:form action="changeemail" method="post"
																...
																<div class="mb-3" style="padding: 20px;">
																	...
																	<form:input class="form-control"
																		...
																		placeholder="Enter Email" path="userEmail"
																		value="${user.userEmail}" style="
												    border: none;
												    border-bottom: 1px solid #80808040;
												    border-radius: 0;
												" />
															...
															<div class="white-box analytics-info">
																...
																<ul
																	...
																	<li class="ms-auto"><span
																			class="counter text-success">${usercount}</span>
																	</li>
																</ul>
															</div>
														</div>
														<div class="col-lg-4 col-md-12">
															<div class="white-box analytics-info">
																...
																<ul
																	...
																	<li class="ms-auto"><span
																			class="counter text-purple">${subusercount}</span>
																	</li>
																</ul>
															</div>
														</div>
														<div class="col-lg-4 col-md-12">
															<div class="white-box analytics-info">
																...
																<ul
																	...
																	<li class="ms-auto"><span
																			class="counter text-info">${feedbackcount}</span>
																	</li>
																</ul>
															</div>
														</div>
																...
																<c:if test="${currentsub.size()>0}">
																	...
																	<table>
																		<tr>
																			...
																			<td>
																				<h6>&ensp; &ensp;Start date</h6>
																			</td>
																			<td>
																				<h6>&ensp; &ensp;End date</h6>
																			</td>
																		</tr>
																		<c:forEach items="${currentsub}" var="bean">
																			<tr>
																				<td>${bean.subPlan}(${bean.duration})
																				</td>
																...
																<c:choose>
																	...
																	<c:otherwise>
																		<table>
																			...
																			<c:forEach items="${payDescription}"
																				var="bean">
																				<tr>
																					<td>${bean.subPlan}(${bean.duration})
																					</td>
																					<td>&ensp; &ensp;${bean.startDate}
																					</td>
																					<td>&ensp; &ensp;${bean.endDate}
																					</td>
																				</tr>
																			</c:forEach>
																		</table>
													...
													<c:forEach items="${recentcomments}" var="rc">
														<div class="comment-widgets">
															...
															<div class="d-flex flex-row comment-row p-3 mt-0"
																...
																<div class="p-2">
																	<img src="${pageContext.request.contextPath}${'\\'}${rc.filePath}"
																...
																<div class="comment-text ps-2 ps-md-3 w-100">
																	...
																	<span class="mb-3 d-block"
																		...
																		${rc.comments} </span>
																	<div
																		class="comment-footer d-md-flex align-items-center">
																				...
																				<c:choose>
																					<c:when test="${rc.rating == 1}">
																						<span class="me-1"> <i
																							...
																							<i
																								class="mdi mdi-star me-n1 mb-2 text-gray fs-6"></i>
																							<i
																								class="mdi mdi-star me-n1 mb-2 text-gray fs-6"></i>
																							<i
																								class="mdi mdi-star me-n1 mb-2 text-gray fs-6"></i>
