							...
							<div class="collapse navbar-collapse " id="navbarTogglerDemo01">
								...
								<ul class="navbar-nav navb mr-auto mt-2 mt-lg-0 bg-warning">
									<c:if test="${sessionLogin==true}">
										<li class="nav-item"><a class="nav-link" href="<c:url value="../course/progress" />">Progress Courses</a></li>
										<li class="nav-item"><a class="nav-link " href="<c:url value="../course/complete" />">Complete Courses</a></li>
										<li class="nav-item"><a class="nav-link" href="<c:url value="../course/courses" />">All Courses</a></li>

									</c:if>

								</ul>
								<c:if test="${sessionLogin!=true}"><i class="bi bi-search search-icon"></i>
									<input id='myInput' class="form-control col-xs-12" onkeyup='searchCourses()'
										aria-label="Search" type='text' placeholder='Search courses with name'>
								</c:if>
								<c:if test="${sessionLogin==true}">
									<input id='myInput' class="form-control col-xs-12 col-md-6"
										onkeyup='searchCourses()' aria-label="Search" type='text'
										placeholder='Search courses with name...'>
								</c:if>
							</div>
						</nav>
					</div>
