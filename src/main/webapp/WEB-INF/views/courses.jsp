...
<link rel="stylesheet"
	href="<c:url value="/resources/css/course.css" />">
<!--Favicon-->
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-warning">
				...
				<div class="collapse navbar-collapse " id="navbarTogglerDemo01">
					...
					<c:if test="${sessionLogin!=true}">
						...
						<input id='myInput' class="form-control col-xs-12"
	...
	<section class="section pt-1 mt-1">
		...
		<div class="container">
			...
			<div class="row justify-content-center card-content">
				...
				<!-- course item -->
				<c:if test="${courseList.isEmpty()}">
				<span class="mt-5 mb-5">Courses do not have.</span>
				</c:if>
				<c:forEach items="${courseList}" var="course">
					<div class="col-lg-4 col-sm-6 mb-5 course-item card"
						style="border: none">
