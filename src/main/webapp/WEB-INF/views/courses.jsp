          ...
          <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-warning">
              ...
              <div class="collapse navbar-collapse " id="navbarTogglerDemo01">
                ...
                <form:form class="form-inline my-2 my-lg-0" action="searchcourse" modelAttribute="course-bean"
                  method="post">
                  <form:input class="form-control mr-sm-2" type="search" path="courseName" placeholder="Search courses"
                    aria-label="Search" value="${searchCourse.courseName }" />
                  <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>

                </form:form>
                <button class="btn my-2 my-sm-0" type="button" onclick="location.href = '<c:url value="
                  /seeAllCourses" />'">See All Course</button>
              </div>
            </nav>
          </div>
        </section>
                ...
                <div class="col-lg-4 col-sm-6 mb-5">
                  <div class="card p-0 border-primary rounded-0 hover-shadow">
                    <div class="card p-0 border-primary rounded-0">
                      <img class="card-img-top rounded-0" src="<c:url value=" ${course.courseImagePath }" />"
                      alt="course thumb">
                    </div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="mt-2">
                        <a href="<c:url value=" /ToeYadanaKyaw/${course.courseId }" />" class="btn btn-primary
                        btn-sm">Apply now</a>
                      </div>
                    </div>
                  </div>
